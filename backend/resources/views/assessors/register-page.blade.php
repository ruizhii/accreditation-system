...
@section('content')
    ...
    <div class="container">
        <form method="POST" action="{{ route('assessors.register') }}">
            @csrf
            ...
            <div class="form-group mt-3">
                ...
                <input type="number" id="ic" name="ic" required>
            </div>
        ...
        <a href="{{ route('assessors.login.page') }}" class="register-link">To Login Page</a>
    </div>
